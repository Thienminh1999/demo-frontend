...
function TableContainer() {
  ...
  const { data, isLoading, isError } = useQueryData({ endPoint: endPoint.ports, queryKey: 'ports-table' });
  ...
  return (
    <ContainerTable>
      <Table rowKey='id' dataSource={ports} columns={columns} loading={isLoading} pagination={{ position: ['bottomCenter'] }} />;
    </ContainerTable>
  );
}
